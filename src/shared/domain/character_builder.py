...
from src.shared.repositories.srd_repository import get_race, get_subrace, get_class, SKILLS
...
def collect_proficiencies(
    ...
    from src.shared.repositories.srd_repository import get_background
