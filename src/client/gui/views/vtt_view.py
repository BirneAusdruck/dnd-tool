...
from src.client.gui.widgets.map_scene import MapScene, Tool
from src.client.gui.widgets.initiative_panel import InitiativePanel
from src.client.gui.widgets.token_item import TOKEN_COLORS, SIZE_LABELS
...
class VTTView(QWidget):
    ...
    def _add_token(self):
        if not self._scene.has_map():
            ...
            return
        from src.client.gui.dialogs.token_dialog import TokenDialog
    ...
    def _remove_selected_token(self):
        for item in self._scene.selectedItems():
            from src.client.gui.widgets.token_item import TokenItem
