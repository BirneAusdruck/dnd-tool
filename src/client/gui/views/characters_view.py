...
class _CharacterCard(QFrame):
    ...
    def _build(self):
        ...
        race_name = RaceService.get(basics.get("race", ""))
        race_name = race_name["name"] if race_name else basics.get("race", "?")
        cls_name = ClassService.get_raw(basics.get("class", ""))
...
class CharactersView(QWidget):
    ...
    def _new_character(self):
        from src.client.gui.dialogs.character_wizard import CharacterWizard
