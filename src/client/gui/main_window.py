...
class MainWindow(QMainWindow):
    ...
    def _add_views(self) -> None:
        from src.client.gui.views.dashboard import DashboardView
        from src.client.gui.views.characters_view import CharactersView
        from src.client.gui.views.vtt_view import VTTView
        from src.client.gui.views.chat_dice_view import ChatDiceView
        from src.client.gui.client.sio_client import SIOClient
        ...
        from src.client.gui.views.campaigns_view import CampaignsView
        ...
        from src.client.gui.views.settings_view import SettingsView
    ...
    def _check_auth_state(self) -> None:
        from src.client.gui.dialogs.auth_dialog import AuthDialog
        try:
    ...
    def _open_character_sheet(self, char: dict) -> None:
        from src.client.gui.views.character_sheet import CharacterSheet
